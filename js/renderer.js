...
const Renderer = {
  ...
  THEMES: {
    ...
    coral:    { name: '珊瑚橘', bg: '#fdf1ec', dot: '#f6d9ca', nodeFill: '#ffffff', nodeBorder: '#ff6f52', nodeText: '#4a2e26', subText: '#9d7a6e', edge: '#f2cfc0', edgeText: '#8f5a47', edgeTextBg: 'rgba(255,255,255,.95)', primary: '#ff6f52', search: '#e0543f', dimNode: 0.16, dimEdge: 0.07 },
    lavender: { name: '雾紫', bg: '#f5f4fa', dot: '#dcd7ec', nodeFill: '#ffffff', nodeBorder: '#a08fc8', nodeText: '#38334d', subText: '#8b84a5', edge: '#d4cce6', edgeText: '#6f6690', edgeTextBg: 'rgba(255,255,255,.95)', primary: '#a08fc8', search: '#f59f24', dimNode: 0.16, dimEdge: 0.07 },
    lime:     { name: '青柠绿', bg: '#f7fbe9', dot: '#e4efc0', nodeFill: '#ffffff', nodeBorder: '#84cc16', nodeText: '#3a461f', subText: '#849368', edge: '#dce8b5', edgeText: '#67754a', edgeTextBg: 'rgba(255,255,255,.95)', primary: '#84cc16', search: '#e8890c', dimNode: 0.16, dimEdge: 0.07 },
    sky:      { name: '天青蓝', bg: '#edf6fd', dot: '#cfe6f7', nodeFill: '#ffffff', nodeBorder: '#38a3e8', nodeText: '#24445e', subText: '#7291ab', edge: '#c2ddf2', edgeText: '#48708f', edgeTextBg: 'rgba(255,255,255,.95)', primary: '#38a3e8', search: '#f59f24', dimNode: 0.16, dimEdge: 0.07 },
    rose:     { name: '玫红', bg: '#fdf0f3', dot: '#f6d3dc', nodeFill: '#ffffff', nodeBorder: '#d23f66', nodeText: '#47242f', subText: '#a07584', edge: '#f0c4d0', edgeText: '#99505f', edgeTextBg: 'rgba(255,255,255,.95)', primary: '#d23f66', search: '#f59f24', dimNode: 0.16, dimEdge: 0.07 },
    fire:     { name: '火橙', bg: '#fdf1e8', dot: '#f6d9bd', nodeFill: '#ffffff', nodeBorder: '#f26622', nodeText: '#4a2c1a', subText: '#a3795a', edge: '#f0d4b8', edgeText: '#8a5a35', edgeTextBg: 'rgba(255,255,255,.95)', primary: '#f26622', search: '#e0543f', dimNode: 0.16, dimEdge: 0.07 },
    navy:     { name: '藏青蓝', bg: '#f2f5fb', dot: '#d6def0', nodeFill: '#ffffff', nodeBorder: '#1e3a8a', nodeText: '#2b3450', subText: '#7c86a8', edge: '#ccd6ec', edgeText: '#4a5680', edgeTextBg: 'rgba(255,255,255,.95)', primary: '#1e3a8a', search: '#f59f24', dimNode: 0.16, dimEdge: 0.07 },
    plum:     { name: '梅子紫', bg: '#f9f0f3', dot: '#ecd4dc', nodeFill: '#ffffff', nodeBorder: '#96395c', nodeText: '#452a38', subText: '#9c7a87', edge: '#e6cede', edgeText: '#8a5468', edgeTextBg: 'rgba(255,255,255,.95)', primary: '#96395c', search: '#f59f24', dimNode: 0.16, dimEdge: 0.07 },
    champagne:{ name: '香槟金', bg: '#faf5ea', dot: '#eee2c8', nodeFill: '#ffffff', nodeBorder: '#c9a86a', nodeText: '#45392a', subText: '#9c8d76', edge: '#e6d9bc', edgeText: '#7d6a4a', edgeTextBg: 'rgba(255,255,255,.95)', primary: '#c9a86a', search: '#e8890c', dimNode: 0.16, dimEdge: 0.07 },
    sage:     { name: '鼠尾草', bg: '#f1f4f1', dot: '#d8e2d9', nodeFill: '#ffffff', nodeBorder: '#78917e', nodeText: '#333f36', subText: '#7e8e82', edge: '#cbd9cd', edgeText: '#5a6f60', edgeTextBg: 'rgba(255,255,255,.95)', primary: '#78917e', search: '#e8890c', dimNode: 0.16, dimEdge: 0.07 },
    terracotta:{ name: '陶土红', bg: '#fbf1ea', dot: '#eed4c4', nodeFill: '#ffffff', nodeBorder: '#b5623f', nodeText: '#44302a', subText: '#937d72', edge: '#e8cdb9', edgeText: '#7d5a45', edgeTextBg: 'rgba(255,255,255,.95)', primary: '#b5623f', search: '#e8890c', dimNode: 0.16, dimEdge: 0.07 },
    ember:    { name: '余烬红', bg: '#26100a', dot: '#4a241a', nodeFill: '#321711', nodeBorder: '#e2704a', nodeText: '#f5e7e1', subText: '#c09585', edge: '#5c3226', edgeText: '#e0a58c', edgeTextBg: 'rgba(38,16,10,.95)', primary: '#e2704a', search: '#e0a63f', dimNode: 0.16, dimEdge: 0.08 },
    cobalt:   { name: '钴蓝', bg: '#0a1430', dot: '#1b2c5e', nodeFill: '#101d45', nodeBorder: '#3b6bf0', nodeText: '#e2e9fb', subText: '#92a2cf', edge: '#25396a', edgeText: '#b0c0ea', edgeTextBg: 'rgba(10,20,48,.95)', primary: '#3b6bf0', search: '#f0a53f', dimNode: 0.16, dimEdge: 0.08 },
    fuchsia:  { name: '洋红', bg: '#230512', dot: '#4a1229', nodeFill: '#320c1d', nodeBorder: '#db4b9b', nodeText: '#f8e2ee', subText: '#c896ae', edge: '#5e2040', edgeText: '#edaac9', edgeTextBg: 'rgba(35,5,18,.95)', primary: '#db4b9b', search: '#f59f24', dimNode: 0.16, dimEdge: 0.08 },
    emerald:  { name: '翡翠绿', bg: '#061f14', dot: '#123d29', nodeFill: '#0c2b1d', nodeBorder: '#34d399', nodeText: '#ddf5ea', subText: '#8fc4a8', edge: '#1d5340', edgeText: '#a9e2c8', edgeTextBg: 'rgba(6,31,20,.95)', primary: '#34d399', search: '#f0a53f', dimNode: 0.16, dimEdge: 0.08 },
    amber:    { name: '琥珀棕', bg: '#241304', dot: '#4a2a10', nodeFill: '#331c0c', nodeBorder: '#e8a33d', nodeText: '#f6ead6', subText: '#c2a077', edge: '#5c3a1c', edgeText: '#e8c48a', edgeTextBg: 'rgba(36,19,4,.95)', primary: '#e8a33d', search: '#e8890c', dimNode: 0.16, dimEdge: 0.08 },
    obsidian: { name: '黑曜石', bg: '#0c0c10', dot: '#23232c', nodeFill: '#15151d', nodeBorder: '#7fb5c9', nodeText: '#e6e9ec', subText: '#97a4ad', edge: '#33333f', edgeText: '#b0bdc7', edgeTextBg: 'rgba(12,12,16,.95)', primary: '#7fb5c9', search: '#e8890c', dimNode: 0.16, dimEdge: 0.08 },
    royal:    { name: '皇室紫', bg: '#170f2e', dot: '#2f2358', nodeFill: '#1f163f', nodeBorder: '#9d6bff', nodeText: '#eae2fb', subText: '#9f92c8', edge: '#372d66', edgeText: '#c3b4ec', edgeTextBg: 'rgba(23,15,46,.95)', primary: '#9d6bff', search: '#f59f24', dimNode: 0.16, dimEdge: 0.08 },
    ink:      { name: '黛青', bg: '#10181c', dot: '#25323a', nodeFill: '#172127', nodeBorder: '#5e8fa2', nodeText: '#e2ecef', subText: '#93a9b2', edge: '#2f444d', edgeText: '#b3c9d2', edgeTextBg: 'rgba(16,24,28,.95)', primary: '#5e8fa2', search: '#e8890c', dimNode: 0.16, dimEdge: 0.08 },
    velvet:   { name: '丝绒绿', bg: '#171b0e', dot: '#333b1c', nodeFill: '#222a14', nodeBorder: '#9faf52', nodeText: '#ecf0d8', subText: '#a8b28a', edge: '#3f482a', edgeText: '#cdd7a8', edgeTextBg: 'rgba(23,27,14,.95)', primary: '#9faf52', search: '#e8890c', dimNode: 0.16, dimEdge: 0.08 }
  },
